...
export const FilterSelectSizes: StoryObj<FilterSelectBasicProps> = {
  ...
  name: 'All the select variants'
}

export const FilterSelectStates: StoryObj<FilterSelectBasicProps> = {
  render: () => {
    return (
      <Box display='flex' flexDirection='column' alignItems='center'>
        <FilterSelect
...
export const MultipleFilterSelect: StoryObj<FilterSelectBasicProps> = {
  render: () => {
      ...
      <Box display='flex' flexDirection='column' alignItems='center'>
        <FilterSelect
          ...
          onChangeValues={(values) =>
            setvalues(values.map((v) => v.toString()))
          }
          onRemove={() => {
            setvalues([])
          }}
...
export const MultipleFilterSelectDisplaySelected: StoryObj<FilterSelectBasicProps> =
  {
    render: () => {
      const [values, setvalues] = useState<SmartKey[]>([])
    ...
    name: 'Multiple select Display Selected'
  }
...
export const VariantsMultipleSelectDisplaySelected: StoryObj<FilterSelectBasicProps> =
  {
    ...
    name: 'Variants Multiple select Display Selected'
  }
